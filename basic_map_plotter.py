...
all_res_path = [filename for filename in glob.glob('**/*.fb1**.res')]
...
good_results = result_elevations[result_elevations['gradeABCNR']=='ACl']
...
fig.coast(land="#666666", lakes = "skyblue", water="skyblue", D = 'h', A = "10/0/2 ")
...
good_results.head(3)
fast_axes_data
good_results[['fast', 'E_fast', 'N_fast']]
